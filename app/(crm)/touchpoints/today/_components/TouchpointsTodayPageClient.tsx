...
export default function TouchpointsTodayPageClient() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Today&apos;s Touchpoints</h1>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                <div className="text-sm text-gray-700">
                  Showing {startIndex + 1} to {Math.min(endIndex, allTodayTouchpoints.length)} of{" "}
                  {allTodayTouchpoints.length} touchpoints
                </div>
