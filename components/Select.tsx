  ...
  return (
    <div className="relative" ref={selectRef}>
      ...
      <button
        ...
        className={`w-full px-4 py-2 pr-3 border border-theme-darker rounded-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-foreground text-left flex items-center justify-between ${
